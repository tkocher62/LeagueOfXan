...
public class NecromancerController : Enemy
{
    ...
    private float health, playerWidth, playerHeight;
    ...
    {
        if (!(transform.position.x < ScreenBorderController.screenBounds.x * -1 + playerWidth ||
        transform.position.y < ScreenBorderController.screenBounds.y * -1 + playerHeight))
        {
